...
#For Two Cas
ion_distance = crys.three_ca(omega_z)[0] #distance between ions, calculated from trap frequency
...
plt.show()
plt.clf()
cont.visualize_gtwo(center_angle, beam_angle, slit_width,ion_distance,debye_waller)