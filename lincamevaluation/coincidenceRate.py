...
meanArray = np.zeros((len(zslook),70))
...
for z in zs:
    ...
    helpercut = temporalCut[int(temporalCut.shape[0]/2)-1]
    meanArray[z] = helpercut
...
print("mean per temporal bin at t=0: " + str(np.mean(meanArray)))
